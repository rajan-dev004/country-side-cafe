...
INSTALLED_APPS = [
    # Jazzmin Admin panel (must be before django.contrib.admin)
    'jazzmin',
...
# CORS Settings
# Set CORS_ALLOW_ALL_ORIGINS to False in production and use CORS_ALLOWED_ORIGINS
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.AllowAny',  # Let views override permissions
    ),
}
...
JAZZMIN_SETTINGS = {
    "site_title": "Country Side Cafe Admin",
    "site_header": "Country Side Cafe",
    "site_brand": "Country Side Cafe",
    "welcome_sign": "Welcome to Country Side Cafe Admin Panel",
    "copyright": "Country Side Cafe Ltd",
    ...
    "order_with_respect_to": ["accounts", "products", "orders", "cart", "wishlist"],
    "theme": "flatly",
